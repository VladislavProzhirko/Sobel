...
AXIM2Mat::AXIM2Mat(sc_module_name name) : sc_module(name), mVcdFile(0) {
    grp_Array2Mat_fu_120 = new Array2Mat("grp_Array2Mat_fu_120");
    grp_Array2Mat_fu_120->ap_clk(ap_clk);
    grp_Array2Mat_fu_120->ap_rst(ap_rst);
    grp_Array2Mat_fu_120->ap_start(grp_Array2Mat_fu_120_ap_start);
    grp_Array2Mat_fu_120->ap_done(grp_Array2Mat_fu_120_ap_done);
    grp_Array2Mat_fu_120->ap_idle(grp_Array2Mat_fu_120_ap_idle);
    grp_Array2Mat_fu_120->ap_ready(grp_Array2Mat_fu_120_ap_ready);
    grp_Array2Mat_fu_120->fb_address0(grp_Array2Mat_fu_120_fb_address0);
    grp_Array2Mat_fu_120->fb_ce0(grp_Array2Mat_fu_120_fb_ce0);
    grp_Array2Mat_fu_120->fb_q0(fb_q0);
    grp_Array2Mat_fu_120->img_rows_V_read(img_rows_V_read_reg_132);
    grp_Array2Mat_fu_120->img_cols_V_read(img_cols_V_read_reg_137);
    grp_Array2Mat_fu_120->img_data_stream_V_din(grp_Array2Mat_fu_120_img_data_stream_V_din);
    grp_Array2Mat_fu_120->img_data_stream_V_full_n(img_data_stream_V_full_n);
    grp_Array2Mat_fu_120->img_data_stream_V_write(grp_Array2Mat_fu_120_img_data_stream_V_write);
    ...
    sensitive << ( ap_done_reg );
    sensitive << ( grp_Array2Mat_fu_120_ap_done );
    ...
    sensitive << ( grp_Array2Mat_fu_120_fb_address0 );
    sensitive << ( ap_CS_fsm_state2 );

    SC_METHOD(thread_fb_ce0);
    sensitive << ( grp_Array2Mat_fu_120_fb_ce0 );
    sensitive << ( ap_CS_fsm_state2 );

    SC_METHOD(thread_grp_Array2Mat_fu_120_ap_start);
    sensitive << ( grp_Array2Mat_fu_120_ap_start_reg );
    ...
    sensitive << ( grp_Array2Mat_fu_120_img_data_stream_V_din );
    sensitive << ( ap_CS_fsm_state2 );

    SC_METHOD(thread_img_data_stream_V_write);
    sensitive << ( grp_Array2Mat_fu_120_img_data_stream_V_write );
    sensitive << ( ap_CS_fsm_state2 );
    ...
    ap_CS_fsm = "01";
    grp_Array2Mat_fu_120_ap_start_reg = SC_LOGIC_0;
    ...
    sc_trace(mVcdFile, img_rows_V_read_reg_132, "img_rows_V_read_reg_132");
    sc_trace(mVcdFile, ap_block_state1, "ap_block_state1");
    sc_trace(mVcdFile, img_cols_V_read_reg_137, "img_cols_V_read_reg_137");
    sc_trace(mVcdFile, grp_Array2Mat_fu_120_ap_start, "grp_Array2Mat_fu_120_ap_start");
    sc_trace(mVcdFile, grp_Array2Mat_fu_120_ap_done, "grp_Array2Mat_fu_120_ap_done");
    sc_trace(mVcdFile, grp_Array2Mat_fu_120_ap_idle, "grp_Array2Mat_fu_120_ap_idle");
    sc_trace(mVcdFile, grp_Array2Mat_fu_120_ap_ready, "grp_Array2Mat_fu_120_ap_ready");
    sc_trace(mVcdFile, grp_Array2Mat_fu_120_fb_address0, "grp_Array2Mat_fu_120_fb_address0");
    sc_trace(mVcdFile, grp_Array2Mat_fu_120_fb_ce0, "grp_Array2Mat_fu_120_fb_ce0");
    sc_trace(mVcdFile, grp_Array2Mat_fu_120_img_data_stream_V_din, "grp_Array2Mat_fu_120_img_data_stream_V_din");
    sc_trace(mVcdFile, grp_Array2Mat_fu_120_img_data_stream_V_write, "grp_Array2Mat_fu_120_img_data_stream_V_write");
    sc_trace(mVcdFile, grp_Array2Mat_fu_120_ap_start_reg, "grp_Array2Mat_fu_120_ap_start_reg");
...
void AXIM2Mat::thread_ap_clk_no_reset_() {
    ...
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, ap_continue.read())) {
            ap_done_reg = ap_const_logic_0;
                    ...
                    esl_seteq<1,1,1>(grp_Array2Mat_fu_120_ap_done.read(), ap_const_logic_1))) {
            ap_done_reg = ap_const_logic_1;
        }
    }
    if ( ap_rst.read() == ap_const_logic_1) {
        grp_Array2Mat_fu_120_ap_start_reg = ap_const_logic_0;
    } else {
        if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && 
            ...
            grp_Array2Mat_fu_120_ap_start_reg = ap_const_logic_1;
        } else if (esl_seteq<1,1,1>(ap_const_logic_1, grp_Array2Mat_fu_120_ap_ready.read())) {
            grp_Array2Mat_fu_120_ap_start_reg = ap_const_logic_0;
        }
    }
    if ( ap_rst.read() == ap_const_logic_1) {
    ...
    if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state1.read()) && !(esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, img_rows_V_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, img_cols_V_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, img_rows_V_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, img_cols_V_out_full_n.read())))) {
        img_cols_V_read_reg_137 = img_cols_V_dout.read();
        img_rows_V_read_reg_132 = img_rows_V_dout.read();
    }
}
...
void AXIM2Mat::thread_ap_block_state1_ignore_call12() {
    ap_block_state1_ignore_call12 = (esl_seteq<1,1,1>(ap_const_logic_0, real_start.read()) || esl_seteq<1,1,1>(ap_done_reg.read(), ap_const_logic_1) || esl_seteq<1,1,1>(ap_const_logic_0, img_rows_V_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, img_cols_V_empty_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, img_rows_V_out_full_n.read()) || esl_seteq<1,1,1>(ap_const_logic_0, img_cols_V_out_full_n.read()));
}
...
void AXIM2Mat::thread_fb_address0() {
    fb_address0 = grp_Array2Mat_fu_120_fb_address0.read();
}

void AXIM2Mat::thread_fb_ce0() {
    fb_ce0 = grp_Array2Mat_fu_120_fb_ce0.read();
}

void AXIM2Mat::thread_grp_Array2Mat_fu_120_ap_start() {
    grp_Array2Mat_fu_120_ap_start = grp_Array2Mat_fu_120_ap_start_reg.read();
}
...
void AXIM2Mat::thread_img_data_stream_V_din() {
    img_data_stream_V_din = grp_Array2Mat_fu_120_img_data_stream_V_din.read();
}

void AXIM2Mat::thread_img_data_stream_V_write() {
    if (esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read())) {
        img_data_stream_V_write = grp_Array2Mat_fu_120_img_data_stream_V_write.read();
    } else {
...
void AXIM2Mat::thread_ap_NS_fsm() {
    switch (ap_CS_fsm.read().to_uint64()) {
        case 1 : 
            ...
            break;
        case 2 : 
            if ((esl_seteq<1,1,1>(ap_const_logic_1, ap_CS_fsm_state2.read()) && esl_seteq<1,1,1>(grp_Array2Mat_fu_120_ap_done.read(), ap_const_logic_1))) {
                ap_NS_fsm = ap_ST_fsm_state1;
            } else {
                ap_NS_fsm = ap_ST_fsm_state2;
            }
