...
struct Sobel : public sc_module {
    ...
    fifo_w5_d2_A* src_rows_V_c10_U;
    fifo_w5_d2_A* src_cols_V_c11_U;
    ...
    sc_signal< sc_lv<7> > AXIM2Mat_U0_fb_address0;
    ...
    sc_signal< sc_lv<7> > Mat2AXIM_U0_fb_address0;
