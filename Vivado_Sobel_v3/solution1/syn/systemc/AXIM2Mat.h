...
struct AXIM2Mat : public sc_module {
    ...
    sc_signal< sc_lv<5> > img_rows_V_read_reg_132;
    sc_signal< bool > ap_block_state1;
    sc_signal< sc_lv<5> > img_cols_V_read_reg_137;
    sc_signal< sc_logic > grp_Array2Mat_fu_120_ap_start;
    sc_signal< sc_logic > grp_Array2Mat_fu_120_ap_done;
    sc_signal< sc_logic > grp_Array2Mat_fu_120_ap_idle;
    sc_signal< sc_logic > grp_Array2Mat_fu_120_ap_ready;
    sc_signal< sc_lv<7> > grp_Array2Mat_fu_120_fb_address0;
    sc_signal< sc_logic > grp_Array2Mat_fu_120_fb_ce0;
    sc_signal< sc_lv<8> > grp_Array2Mat_fu_120_img_data_stream_V_din;
    sc_signal< sc_logic > grp_Array2Mat_fu_120_img_data_stream_V_write;
    sc_signal< sc_logic > grp_Array2Mat_fu_120_ap_start_reg;
    ...
    void thread_fb_ce0();
    void thread_grp_Array2Mat_fu_120_ap_start();
