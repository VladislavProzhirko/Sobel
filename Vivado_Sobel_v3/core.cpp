...
void Sobel(uint8_t image_in[10*10], uint8_t image_out[10*10]){
...
//#pragma HLS array_reshape variable=image_in cyclic factor=2 dim=1
...
#pragma HLS RESOURCE variable=image_out core=RAM_1P_BRAM
	...
	hls::AXIM2Mat<10,uint8_t,10,10,HLS_8UC1>(image_in,src);
	...
	hls::Mat2AXIM<10,uint8_t,10,10,HLS_8UC1>(dst,image_out);
}
